    ...
    <div class="container-fluid text-center">
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                ...
                <h2>Partie 8</h2>
                <p class="lead">Sur le formulaire de l'exercice 6, en plus de ce qui est demandé 
                sur les exercices précédent, vérifier que le fichier transmis est bien un fichier pdf.</p>
        ...
        <div class="row justify-content-center">   
            <?php
                ...
                if (empty($_GET['civilite']) || empty($_GET['lastname']) || empty($_GET['firstname']) || empty($_GET['file']) || ($extension != 'pdf')) {
                    ...
                    if(!empty($_GET)){
                        ...
                        // On test l'extension du fichier envoyé
                        } elseif ($extension != 'pdf'){
                            $fileErr = "Veuillez sélectionner un fichier .pdf !";
                        }
                    }
            ?>    
